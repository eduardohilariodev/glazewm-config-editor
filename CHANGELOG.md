...
## [0.1.3](https://github.com/eduardohilariodev/glazewm-config-editor/compare/v0.1.2...v0.1.3) (2026-04-30)
...
* only inject Apple signing env vars when certificate secret is configured ([663e25a](https://github.com/eduardohilariodev/glazewm-config-editor/commit/663e25a97881ac0a8ef5c47420d6449eea9930d8))
* publish release on workflow_dispatch as well as release event ([b30979a](https://github.com/eduardohilariodev/glazewm-config-editor/commit/b30979ae30fb0dd273e0218020d11cc1c730ddcc))
...
* use ad-hoc codesigning on macOS when no Apple certificate is configured ([cabde1b](https://github.com/eduardohilariodev/glazewm-config-editor/commit/cabde1bf8190d1e304a5f5c2395d82c583653357))
