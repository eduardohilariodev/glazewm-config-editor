...
<nav class="flex justify-center gap-1 border-b border-[#333] px-2">
  {#each tabs as tab (tab.id)}
    ...
    <button
      ...
      class="inline-flex items-center gap-[0.45rem] px-4 py-[0.6rem] border-0 bg-transparent cursor-pointer font-[inherit] text-[0.95rem] border-b-2 border-transparent hover:text-white {active === tab.id ? 'text-[#0289a3] !border-b-[#0289a3]' : 'text-[#aaa]'}"
